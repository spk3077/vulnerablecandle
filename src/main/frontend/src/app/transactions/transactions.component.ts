...
export class TransactionsComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if(this.submitted){
      ...
      this.productReviewService.createProductReview(new ProductReviewSend(this.addReviewForm.value.product, this.addReviewForm.value.title, this.addReviewForm.value.rating, this.addReviewForm.value.review.replace(/[<>]/g, ''))).subscribe({
        next: (res) => {
